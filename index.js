...
function getCarInfoByIndex(car_make, car_model) {
  var car_make = "Lincoln";
  var car_model = "Navigator";
...
*/
function getLastCarInfo(car_make, car_model) {
  var car_make = "Lincoln";
  var car_model = "Town Car";
  return "This is a " + car_make + car_model;
}
 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(car_make, car_model) {
  var car_make = "Lincoln, Honda, Smart";
  var car_model = "Navigator, Accord, Fortwo";
  return "This is a " + car_make + car_model;
}
...
function getGermanCars(inventory) {
  ...
  for (let i = 0; i < inventory.length; i++){
    ...
    inventory[i].car_make === "Mercedes-Benz" || inventory[i].car_make === "Volkswagen"){
